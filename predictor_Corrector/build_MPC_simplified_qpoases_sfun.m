...
prob_files = ["MPC_simplified_qpoases_prep.c", "MPC_simplified_qpoases.c", "pdip.c"];
...
if USE_CPP
	mex('-v', ['-I' DYNOPT_PATH], ['-I', fullfile(DYNOPT_PATH, solver, 'include')], ['-L', lib_path], ['-L', 'blasfeo_path'], problem_files{:}, req_files_path{:}, fullfile(DYNOPT_PATH,"*.cpp"), ['-l', 'qpOASES'], ['-l', 'blasfeo'], '-outdir', './');
else
