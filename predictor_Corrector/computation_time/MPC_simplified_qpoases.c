...
void MPC_simplified_call(double *z_op, double *x0, double *pd, double *Q11, double *Q22, double *R, double *umax, double *z_opt, int *exit_flag, double *u0, int *iter_count)
{
	...
	iter_count[0] = options_pd.iter_count;
