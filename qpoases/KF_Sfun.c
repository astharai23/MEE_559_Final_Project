...
#define S_FUNCTION_NAME                KF_Sfun
...
#define SOURCEFILES                    "__SFB__EKF_Func.c__SFB__EKF_Func_Call.c"
#define PANELINDEX                     0
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  const real_T *xhatp = (real_T *) ssGetInputPortRealSignal(S, 2);
  const real_T *Pkp = (real_T *) ssGetInputPortRealSignal(S, 3);
  const real_T *Q11 = (real_T *) ssGetInputPortRealSignal(S, 4);
  const real_T *Q22 = (real_T *) ssGetInputPortRealSignal(S, 5);
  const real_T *Q33 = (real_T *) ssGetInputPortRealSignal(S, 6);
  const real_T *R = (real_T *) ssGetInputPortRealSignal(S, 7);
  real_T *xhat = (real_T *) ssGetOutputPortRealSignal(S, 0);
  real_T *Phat = (real_T *) ssGetOutputPortRealSignal(S, 1);
  KF_Sfun_Outputs_wrapper(u, y, xhatp, Pkp, Q11, Q22, Q33, R, xhat, Phat);
}
